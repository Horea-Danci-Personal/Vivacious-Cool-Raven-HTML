...
const Home = (props) => {
  return (
    ...
    <button>Download Resume</button>
      ...
      <img
        alt="image"
        src="/external/azure-200h.png"
        className="home-image4"
      />
      <img
        alt="image"
        src="/external/css-300h.png"
        className="home-image5"
      />
      <img
        alt="image"
        src="/external/html-200h.png"
        className="home-image6"
      />
      <h1
        id="Contact"
        className="home-text60"
      >
        Contact 
      </h1>
      <img
